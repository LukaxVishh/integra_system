...
const OperacoesSidebar: React.FC<OperacoesSidebarProps> = ({ activeTab, setActiveTab, setSelectedButtonId }) => (
  <aside className="inline-block bg-white rounded-2xl shadow p-4 border border-[#E6F4EA] w-72">
    <div className="flex items-center gap-2 mb-4">
      <BriefcaseIcon className="w-5 h-5 text-[#0F9D58]" />
      <h2 className="text-lg font-bold text-[#0F9D58]">Operacões de Crédito</h2>
    </div>
...
export default OperacoesSidebar;
