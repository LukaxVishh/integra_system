import { BookOpenIcon, ClipboardIcon, UsersIcon, ClipboardDocumentCheckIcon } from "@heroicons/react/24/outline";

interface ProcessosSidebarProps {
...
const ProcessosSidebar: React.FC<ProcessosSidebarProps> = ({ activeTab, setActiveTab, setSelectedButtonId }) => (
  <aside className="inline-block bg-white rounded-2xl shadow p-4 border border-[#E6F4EA] w-72">
    <div className="flex items-center gap-2 mb-4">
      ...
      <h2 className="text-lg font-bold text-[#0F9D58]">Processos e Qualidade</h2>
    </div>
...
export default ProcessosSidebar;
