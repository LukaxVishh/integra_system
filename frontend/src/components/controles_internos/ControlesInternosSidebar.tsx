import { BookOpenIcon, ClipboardIcon, UsersIcon } from "@heroicons/react/24/outline";
import { ShieldCheckIcon } from "lucide-react";

interface ControlesInternosSidebarProps {
...
const ControlesInternosSidebar: React.FC<ControlesInternosSidebarProps> = ({ activeTab, setActiveTab, setSelectedButtonId }) => (
  <aside className="inline-block bg-white rounded-2xl shadow p-4 border border-[#E6F4EA] w-72">
    <div className="flex items-center gap-2 mb-4">
      <ShieldCheckIcon className="w-5 h-5 text-[#0F9D58]" />
      <h2 className="text-lg font-bold text-[#0F9D58]">Controles Internos</h2>
    </div>
...
export default ControlesInternosSidebar;
