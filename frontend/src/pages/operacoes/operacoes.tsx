...
import OperacoesInfinitePosts from "../../components/operacoes/informativos/OperacoesInfinitePosts";
import OrientadorGrid from "../../components/operacoes/orientador/OrientadorGrid";
import OrientadorTableEditor from "../../components/operacoes/orientador/OrientadorTableEditor";
import OperacoesSidebar from "../../components/operacoes/OperacoesSidebar";
import OperacoesColaboradores from "../../components/operacoes/colaboradores/OperacoesColaboradores"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F9FAFB]">
      ...
      <main className="flex-grow px-4 pt-20 pb-4 flex flex-col md:flex-row gap-4 items-start">
        {/* Sidebar */}
        <OperacoesSidebar activeTab={activeTab} setActiveTab={setActiveTab} setSelectedButtonId={setSelectedButtonId}></OperacoesSidebar>    
