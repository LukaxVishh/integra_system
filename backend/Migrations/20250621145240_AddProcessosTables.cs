...
{
    /// <inheritdoc />
    public partial class AddProcessosTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ProcessosColaboradorAtividades",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessosColaboradorAtividades", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProcessosOrientadorButtons",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessosOrientadorButtons", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ProcessosOrientadorTables",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessosOrientadorTables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProcessosOrientadorTables_CicloOrientadorButtons_ButtonId",
                        column: x => x.ButtonId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProcessosPosts", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_ProcessosOrientadorTables_ButtonId",
                table: "ProcessosOrientadorTables",
                column: "ButtonId");
        }
